 ...
 * An email must be explicitly listed in the site's allowed_emails to gain access.
 * The global email list is NOT used here — it only controls web app dashboard access.
 */
